...
<body>
    ...
    <div class="sidebar">
        <div class="sidebar-brand">
            <h1><span class="lab la-accusoft"></span>Admin Dashboard</h1>
        </div>
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="ad_admins.php" ><span class="las la-user-cog"></span>
                        <span>Admins</span></a>
                </li>
         ...
         <div class="main2 row">
            <div class="col-4 ">
                <div class="card bg-info" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        <center>
                            <h1 class="card-title">View Doctor</h1>
                        </center>
                        <p class="card-text"></p>
            ...
            <div class="col-4">
                <div class="card bg-warning" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"></p>
                        <center><a href="../login/doctors_sign_up.php" class="btn btn-success">Add</a></center>
                    </div>
                </div>
            </div>
            ...
            <div class="col-4">
                ...
                <div class="card bg-danger" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        <center>
                            <h1 class="card-title">Drop Doctor</h1>
                        </center>
                        <p class="card-text"></p>

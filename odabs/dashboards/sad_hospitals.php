    ...
    <div class="main-content">
        <header>
            ...
            <div class="user-wrapper">
                <img src="../img/avatar.svg" height="40px" width="40px " alt="">
        ...
        <!--SUper admin dashboard Hospitals page-->
        <div class="main2 row">
            <div class="col-4 ">
                <div class="card bg-info" style="width: 20rem;">
                    ...
                    <div class="card-body">
                        <center>
                            <h1 class="card-title">View Hospitals</h1>
                        </center>
                        <p class="card-text"></p>
                        <center><a href="../hospital.php" class="btn btn-success">View</a></center>
                    </div>
                </div>
            </div>
            ...
            <div class="col-4">
                <div class="card bg-warning" style="width: 20rem;">
                    ...
                    <div class="card-body">
                        ...
                        <center>
                            <h1 class="card-title">Add Hospital</h1>
                        </center>
                        <p class="card-text"></p>
                        <center><a href="../login/add_hospital_sign_up.php" class="btn btn-success">Add</a></center>
                    </div>
                </div>
            </div>
            ...
            <div class="col-4">
                ...
                <div class="card bg-danger" style="width: 20rem;">
                    ...
                    <div class="card-body">
                        <center>
                            <h1 class="card-title">Drop Hospital</h1>
                        </center>
                        <p class="card-text"></p>
